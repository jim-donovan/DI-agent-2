...
class ContentFormattingAgent(BaseAgent):
    ...
    def __init__(self, logger: ProcessingLogger, api_key: str):
        super().__init__("content_formatting_agent", logger, api_key)
        # Formatting modules removed - using strategy-based approach instead
        
    def get_system_prompt(self) -> str:
        """Get the system prompt for content formatting."""
        return """Transform the extracted text using these formatting rules:
...
* You are permitted to remove page numbers and other page-related metadata.
...
## Other formatting principles and instructions
